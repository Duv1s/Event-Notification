...
public class NotificationController {
    ...
    public NotificationPageResponse list(
        ...
        ClientId clientId = clientIdResolver.resolve(request);
    ...
    public NotificationDetailResponse get(@PathVariable String id, HttpServletRequest request) {
        ClientId clientId = clientIdResolver.resolve(request);
        return WebMapper.toDetail(getNotification.handle(new EventId(id), clientId));
    }

    @PostMapping("/{id}/replay")
    @Operation(summary = "Replay a definitively failed notification (asynchronous)")
    public ResponseEntity<ReplayResponse> replay(@PathVariable String id, HttpServletRequest request) {
        ClientId clientId = clientIdResolver.resolve(request);
        replayNotification.handle(new EventId(id), clientId);
